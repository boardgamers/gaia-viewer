<template>
  <g class="resource">
    ...
    <rect v-else-if="kind=='pw' || kind=='pay-pw' || kind=='t' || kind=='brainstone'" class="power" width="15" height="15" ry="7.5" rx="7.5" x="-7.5" y="-7.5" />
    ...
    <text x="0" y="0" v-if="count >=0 && ['o','c','k','pw','pay-pw','t','vp','q','ship','gf'].includes(kind) || count === '+'" :class="{plus: count === '+'}">{{count}}</text>
