  ...
  <div id="move">
    ...
    <div id="move-buttons">
      ...
      <div v-else-if="chooseFaction">
        <MoveButton v-for="faction in command.data" :button="{command: `${command.name} ${faction}`,  tooltip:`${tooltip(faction)}`, label:`${factions[faction].name}`}" @trigger="handleCommand" :key="faction">
